    ...
    <div class="content-wrapper">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <h6 class="text-muted font-weight-normal">Order Processsing</h6>
        </div>
      </div>
    </div>
    <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <div class="row">
            <div class="col-9">
              <div class="d-flex align-items-center align-self-start">
                <h3 class="mb-0">{{  $total_pengemasan }}</h3>
                {{-- <p class="text-success ms-2 mb-0 font-weight-medium">+3.5%</p> --}}
              </div>
            </div>
            <div class="col-3">
          ...
          <h6 class="text-muted font-weight-normal">Order Sedang Dikemas</h6>
        </div>
      </div>
    </div>
    <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          <h6 class="text-muted font-weight-normal">Order Dalam Perjalanan</h6>
        </div>
      </div>
    </div>
